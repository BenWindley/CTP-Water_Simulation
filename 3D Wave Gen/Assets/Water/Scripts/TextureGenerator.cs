...
public class TextureGenerator : MonoBehaviour
{
    ...
    private int kernal_combination;
    ...
    {
        RunShader();
        waterMat.SetFloat("_MeshBounds", GetComponent<MeshFilter>().mesh.bounds.size.x);
    }
    ...
    private void Update()
    {
        ...
        //waterMat.mainTexture = displacement_map;
